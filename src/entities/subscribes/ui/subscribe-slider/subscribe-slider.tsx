...
import { setIndex } from "@/entities/subscribes/model/subscribesSlice";
import { Subscribe } from "@/entities/subscribes/model/types";
  ...
  return (
    <Swiper
      ...
      onInit={(swiper) => {
        ...
        dispatch(setIndex(slides[activeSlideIndex]?.id));
      }}
